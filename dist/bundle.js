...
class Display {
    ...
    drawTerminalText(ctx, row, column, text) {
        return __awaiter(this, void 0, void 0, function* () {
            let x = column * 8;
            let y = (row + 1) * 12;
            yield this.delay(this.msInSec);
            ctx.fillText(text.toUpperCase(), x, y);
        });
    }
    render() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.delay(15 * this.msInSec);
        });
    }
    run() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    render() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < packages.length; i++) {
                yield this.drawTerminalText(ctx, i, 0, packages[i].id);
