...
/*!************************!*\
  !*** ./src/display.ts ***!
  \************************/
/*! exports provided: canvasHeight, msInSec, msInMin, Display */
...
let displayMap = {
    ...
    git: (e) => new _display__WEBPACK_IMPORTED_MODULE_1__["Display"](e),
    ...
    render() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < packages.length; i++) {
                ...
                yield this.drawTerminalText(ctx, i, 32, packages[i].totalDownloads.toString());
            }
            let series = packages
                .map(p => p.versions
                .map(v => [v.version, v.downloads]));
            yield this.drawLineGraphs(ctx, series);
    ...
    drawLineGraphs(ctx, series) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < series.length; i++) {
                ctx.beginPath();
                ctx.moveTo(0, _display__WEBPACK_IMPORTED_MODULE_0__["canvasHeight"] - (series[i][0][1] * scaley));
                yield this.delay(_display__WEBPACK_IMPORTED_MODULE_0__["msInSec"]);
                for (let j = 0; j < series[i].length; j++) {
                    let [label, value] = series[i][j];
                    let x = j * dx;
                    let y = _display__WEBPACK_IMPORTED_MODULE_0__["canvasHeight"] - (value * scaley);
                    ctx.lineTo(x, y);
