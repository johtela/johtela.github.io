...
function animateMonitors() {
    jquery__WEBPACK_IMPORTED_MODULE_0__(".monitor-content").map((i, e) => new _display__WEBPACK_IMPORTED_MODULE_1__["Display"](e)).each((i, d) => {
        d.run();
    });
}
