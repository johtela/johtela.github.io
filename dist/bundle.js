...
class Display {
    constructor(content) {
        ...
        this.canvas = jquery__WEBPACK_IMPORTED_MODULE_0__('<canvas>')[0];
    ...
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            while (true) {
                ...
                let cont = jquery__WEBPACK_IMPORTED_MODULE_0__(this.content);
                yield this.flickerEffect(cont);
                this.canvas.width = this.content.clientWidth;
                cont.replaceWith(this.canvas);
                yield this.render();
                jquery__WEBPACK_IMPORTED_MODULE_0__(this.canvas).replaceWith(this.content);
            }
        });
    }
    flickerEffect(cont) {
...
class GithubDisplay extends _display__WEBPACK_IMPORTED_MODULE_0__["Display"] {
    ...
    render() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let contribs = yield Object(_github_contrib__WEBPACK_IMPORTED_MODULE_1__["contribHistory"])(this.username);
            let x = xstart;
            let month = 0;
...
/*!*******************************!*\
  !*** ./src/github-contrib.ts ***!
  \*******************************/
/*! exports provided: fetchEvents, contribHistory */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _nug_display__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./nug-display */ "./src/nug-display.ts");
/* harmony import */ var _git_display__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./git-display */ "./src/git-display.ts");




let displayMap = {
    nuget: (e) => new _nug_display__WEBPACK_IMPORTED_MODULE_2__["NugetDisplay"](e, "Tommi Johtela"),
    git: (e) => new _git_display__WEBPACK_IMPORTED_MODULE_3__["GithubDisplay"](e, "johtela"),
    linkedin: (e) => new _display__WEBPACK_IMPORTED_MODULE_1__["Display"](e)
};
function animateMonitors() {
    jquery__WEBPACK_IMPORTED_MODULE_0__(".monitor-content")
        .map((i, e) => displayMap[e.id](e))
        .each((i, d) => {
        d.run();
    });
}
jquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(animateMonitors);
